...
#     err "Software directory is empty"
# fi
...
# echo "$@"
/usr/bin/osquery-scan \
    --flagfile=/etc/osquery/flags/osquery.flags \
    --disable_events \
    --disable-database \
    --verbose \
    ...
    --enroll_secret_path=/etc/osquery/secrets/uptycs.secret \
    --augeas_lenses=/usr/share/osquery/lenses \
    --ebpf_default_offsets=/usr/share/osquery/ebpf_offsets.json \
...
# exec chroot ${CHROOT_DIR} tree ${BINARY_DIR}
